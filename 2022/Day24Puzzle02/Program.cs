...
int minutesToGetThereFirst = GetMinutesRequiredToGetFromTo(startingTile, targetTile);
int minutesToGetBack = GetMinutesRequiredToGetFromTo(targetTile, startingTile);
int minutesToGetThereAgain = GetMinutesRequiredToGetFromTo(startingTile, targetTile);

Console.WriteLine($"Go: {minutesToGetThereFirst}, Back: {minutesToGetBack}, Again: {minutesToGetThereAgain}, Total: {minutesToGetThereFirst + minutesToGetBack + minutesToGetThereAgain}");


int GetMinutesRequiredToGetFromTo(Tile startingTile, Tile targetTile)
{
    startingTile.IsStartingTile = true;
    startingTile.IsTargetTile = false;
    targetTile.IsStartingTile = false;
