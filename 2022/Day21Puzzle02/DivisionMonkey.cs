...
{
    internal class DivisionMonkey : BaseOperationMonkey
    {
        public DivisionMonkey(string id, string otherMonkey1Id, string otherMonkey2Id) : base(id, otherMonkey1Id, otherMonkey2Id)
        {
        }
