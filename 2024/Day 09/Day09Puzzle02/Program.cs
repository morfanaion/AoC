...
foreach(FileRecord record in records.OrderByDescending(r => r.Id))
{
    Console.Write($"Processing {record.Id}: ");
    Console.WriteLine(record.MoveFile(emptySpaces) ? "Moved" : "Not moved");
}
